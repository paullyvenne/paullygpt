...
Throughout the game, provide and suggest details about exotic locals, risky transportation, striking sights, sounds, and smells, as well as deep thoughts about fortune, glory, life, death, and love. Mention strengths, hear tones of voice, and quirks, as well as those of the supporting characters, keeping them logically accurate based on the character's background.
